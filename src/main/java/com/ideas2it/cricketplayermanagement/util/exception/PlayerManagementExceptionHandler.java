...
public class PlayerManagementExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> notFoundException(PlayerManagementException playerManagementException) {
        ErrorMessage errorMessage = new ErrorMessage(playerManagementException.getStatus(), playerManagementException.getMessage());
        return new ResponseEntity<>(errorMessage, playerManagementException.getStatus());
    }
