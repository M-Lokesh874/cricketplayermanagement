...
public class CricketPlayerController {
    ...
    @PostMapping(value = "/save-cricket-Player")
    public ResponseEntity<?> createCricketPlayer(@RequestBody CricketPlayer cricketPlayer) {
        try {
            ...
            return ResponseEntity.of(Optional.of(objectMapper.convertPlayerEntityIntoDto(cricketPlayer)));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> fetchCricketPlayers() {
        try {
            ...
            if (!cricketPlayers.isEmpty()) {
                return ResponseEntity.of(Optional.of(objectMapper.convertPlayerEntityIntoDto(cricketPlayers)));
            } else {
